...
namespace Tools
{
    public class XMLHelper
    {
        ...
        private XMLHelper() { }
        private XMLHelper(string strFileName)
        {
        ...
        public bool DeleteXmlNodeByXPath(string xpath)
        {
            ...
            try
            {
                xmldoc.Load(m_strFileName); //加载XML文档
                ...
                xmldoc.Save(m_strFileName); //保存到XML文档
                isSuccess = true;
            }
            catch (Exception ex)
            {
